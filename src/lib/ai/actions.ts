...
- MODE « SURPRENDS-MOI » : si l'utilisateur demande explicitement d'être surpris/étonné ou de sortir de ses habitudes ("surprends-moi", "un truc différent de d'habitude", "sors-moi de ma zone de confort"), inclus une majorité de titres qui restent compatibles avec son goût (même mécanique/ton sous-jacent) mais qui divergent volontairement du choix le plus évident — la reason doit alors le dire explicitement ("Ça sort un peu de tes habitudes habituelles, mais ça garde [élément commun]…"), jamais un titre incompatible juste pour surprendre à tout prix.${context}
