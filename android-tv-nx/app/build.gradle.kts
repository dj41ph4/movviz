...
android {
    ...
    defaultConfig {
        ...
        versionCode = ((project.findProperty("movvizVersionCode") as String?)?.toIntOrNull()) ?: 124089
        versionName = (project.findProperty("movvizVersionName") as String?) ?: "1.24.89"
...
dependencies {
    ...
    // Rangées Google TV — chaîne "Movviz" + rangée système "Continuer"
    // (Watch Next), voir tvchannel/TvChannelProvider.kt.
