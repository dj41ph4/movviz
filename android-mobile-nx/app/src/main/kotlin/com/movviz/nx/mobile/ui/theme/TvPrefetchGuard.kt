 ...
 * plantait au premier scroll tactile (NoSuchMethodError, app tuée
 * immédiatement) — reproduit en slidant une rangée d'affiches sur l'onglet
 * Découverte. androidx.tv n'a jamais republié tv-foundation contre un
 * foundation plus récent sans casser tout son ancien paquet lazy.* (voir
 * tv-foundation 1.0.0 stable, incompatible en API) donc bumper la lib n'est
 * pas une option ici.
 *
